...
<!-- Filter Tabs - Always visible for navigation -->
    ...
    <div class="text-center py-12">
        @if(request('type'))
            @php
                ...
                $emoji = $typeEmojis[$currentType] ?? '📁';
                $typeName = $typeNames[$currentType] ?? 'files';
            @endphp
            <span class="text-6xl">{{ $emoji }}</span>
            <h3 class="text-lg font-semibold text-gray-900 mt-4">No {{ $typeName }} yet</h3>
            <p class="text-gray-600 mt-2">Upload some {{ $typeName }} or check other media types using the tabs above.</p>
        @else
    ...
    <div class="bg-white rounded-xl max-w-4xl w-full max-h-[95vh] overflow-hidden shadow-2xl">
        <div class="flex h-full max-h-[95vh]">
            ...
            <div id="modal-image-panel" class="flex-1 bg-gray-100 flex items-center justify-center relative min-h-[400px]">
                ...
                <!-- Close Button -->
                <button id="close-modal" onclick="closeMediaModal()" 
            ...
            <!-- Details Panel -->
            <div class="w-80 bg-white border-l border-gray-200 flex flex-col max-h-full">
                <!-- Header -->
                ...
                <div class="flex-1 overflow-y-auto min-h-0">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <button id="save-metadata" onclick="saveMediaMetadata()" 
                    ...
                    <div class="px-6 pb-4 border-t border-gray-200">
                        ...
                        <div class="space-y-1">
                            <button onclick="copyUrl('original')" 
                                    class="w-full text-left px-3 py-1.5 bg-gray-50 hover:bg-gray-100 rounded border text-xs">
                                📄 Original URL
                            </button>
