    ...
    <form method="POST" action="{{ route('wlcms.admin.content.store') }}" enctype="multipart/form-data" 
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                {{-- Collections & Features Card --}}
                <div class="bg-white rounded-lg shadow p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">📌 Collections & Features</h3>
                    
                    <div class="space-y-4">
                        @php
                            $collections = config('wlcms.collections', []);
                            $allowCustom = config('wlcms.allow_custom_collections', true);
                            $currentCollection = old('meta.collection', '');
                        @endphp
                        ...
                        <div x-data="{ 
                            ...
                            <select id="collection" 
                                ...
                                @endforeach
                                @if($allowCustom)
                                    <option value="_custom_">✏️ Custom...</option>
                                @endif
                            </select>
