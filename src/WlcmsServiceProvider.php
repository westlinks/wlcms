        ...
        \Westlinks\Wlcms\Services\TemplateManager::register('editorial-letter', array_merge([
            ...
            'settings_schema' => [
                'author_name' => [
                    ...
                    'label' => 'Author Name',
                    'default' => '',
                    'help' => 'Full name of the person writing this message (e.g., Jane D.). Used for the signature and avatar initials if no photo is set.',
                ],
                'author_role' => [
                    'type' => 'text',
                    'label' => 'Author Title / Role',
                    'default' => '',
                    'help' => 'Official title or service role of the author (e.g., 51st Convention Chairperson or Marathon Meetings Chair).',
                ],
                'badge_text' => [
                    'type' => 'text',
                    'label' => 'Header Badge Text',
                    'default' => 'Welcome Message',
                    'help' => 'Small pill badge shown at the top of the header card (e.g., Welcome Message). Leave blank to hide.',
                ],
                'highlight_text' => [
                    'type' => 'text',
                    'label' => 'Featured Highlight / Theme',
                    'default' => '',
                    'help' => 'The official theme or theme quote. Leave blank to hide the theme banner completely on sub-chairperson pages.',
                ],
                'highlight_label' => [
                    'type' => 'text',
                    'label' => 'Highlight Banner Label',
                    'default' => 'Convention Theme',
                    'help' => 'Small label above the theme text (e.g., Convention Theme or Theme Quote). Only shows if Theme is provided.',
                ],
                'footer_badge' => [ 
                    'type' => 'text',
                    'label' => 'Footer Event Badge Text',
                    'default' => 'SFVAAC 51st Annual Convention',
                    'help' => 'Event name badge displayed on the bottom right opposite the signature line (e.g., SFVAAC 51st Annual Convention).',
                ],
            ],
        ], $override));
    }
